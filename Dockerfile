...
RUN apt-get install -y libnss3-dev=3.98-0ubuntu0.22.04.2 libasound2=1.2.11-1build2 libxss1=1:1.2.3-1build3 libappindicator3-1=0.4.92-8ubuntu1 libindicator7=0.5.0-8ubuntu1 gconf2=3.2.6-8ubuntu2 libpango1.0-0=1.50-1ubuntu0.1 xdg-utils=1.1.0+dfsg-2 fonts-liberation=1.0.12-1
